...
void Player::OnUpdate(Hazel::Timestep ts)
{
	...
	if (Input::IsKeyPressed(HZ_KEY_SPACE) || Hazel::Input::IsMouseButtonPressed(HZ_MOUSE_BUTTON_LEFT))
	{
...
void Player::OnRender()
{
	...
	RendererOld2D::DrawRotatedQuadGame({ m_Position.x, m_Position.y, 0.5f }, { 1.0f, 1.3f }, glm::radians(GetRotation()), m_ShipTexture);
}
