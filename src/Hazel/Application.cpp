...
#define BIND_EVENT_FN(x) std::bind(&Application::x, this, std::placeholders::_1)
		...
		:m_Camera(-1.6f, 1.6f, -0.9f, 1.0f)
	{
		...
		std::shared_ptr<IndexBuffer> m_SquareIB(IndexBuffer::Create(squareindices, sizeof(squareindices) / sizeof(uint32_t)));		
		...
		m_Shader2.reset(new Shader(vertexSrc2, fragSrc2));
	}
